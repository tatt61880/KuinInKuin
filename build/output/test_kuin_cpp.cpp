...
(_ahn) = ((_ahn)->Cat(toBin_((_ahm)->_ur)));
(_ahn) = ((_ahn)->Cat(toBin_((_ahm)->_us)));
return _ahn;
}
// _fromBin
static _um* _uq(_um* _ahq, Array_<uint8_t>* _ahr, int64_t* _ahs){
