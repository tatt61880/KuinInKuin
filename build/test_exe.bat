...
.\kuincl.exe -i "%~dp0test_data/test_exe.kn" -o "%~dp0output/exe_correct/test_exe_correct.exe" -s "%~dp0./sys/" -e cui
...
.\output\x64\Release\kuin_cpp.exe -i "%~dp0test_data/test_exe.kn" -o "%~dp0output/exe_output/test_exe" -s "%~dp0../src/compiler/res/sys/" -e exe
